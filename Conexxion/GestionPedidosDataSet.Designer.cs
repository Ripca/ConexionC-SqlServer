            ...
            public int cCliente {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'cCliente\' in table \'Pedido\' is DBNull.", e);
                    }
                }
                set {
...
namespace Conexxion.GestionPedidosDataSetTableAdapters {
...
SELECT Id, seccion, fecha, nombreArticulo, paisOrigen, precio FROM articulo WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Conexxion.Properties.Settings.Default.GestionPedidosConnectionString;
        }
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Cliente] WHERE (([Id] = @Original_Id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([nombre], [direccion], [telefono]) VALUES (@nombre, " +
                "@direccion, @telefono);\r\nSELECT Id, nombre, direccion, telefono FROM Cliente WHE" +
...
SELECT Id, nombre, direccion, telefono FROM Cliente WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, nombre, direccion, telefono FROM dbo.Cliente";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
